...
mixin _$Message implements DiagnosticableTreeMixin {
 ...
 String get id; MessageRole get role; String get content; DateTime get timestamp; bool get isTyping; Map<String, dynamic>? get metadata;
...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'Message(id: $id, role: $role, content: $content, timestamp: $timestamp, isTyping: $isTyping, metadata: $metadata)';
}
...
@useResult
$Res call({
 String id, MessageRole role, String content, DateTime timestamp, bool isTyping, Map<String, dynamic>? metadata
});
...
$MessageRoleCopyWith<$Res> get role {
  ...
  return $MessageRoleCopyWith<$Res>(_self.role, (value) {
...
class _Message with DiagnosticableTreeMixin implements Message {
  const _Message({required this.id, required this.role, required this.content, required this.timestamp, this.isTyping = false, final  Map<String, dynamic>? metadata}): _metadata = metadata;
...
@override $MessageRoleCopyWith<$Res> get role;
