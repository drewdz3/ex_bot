    ...
    class EnvironmentConfig {
      ...
      static Map<String, String> get configSummary => {
        'apiKeyConfigured': azureOpenaiApiKey.isNotEmpty
            ? 'Yes (${azureOpenaiApiKey.length} chars)'
            : 'No',
        'endpoint': azureOpenaiEndpoint.isEmpty
            ? 'Not configured'
            : azureOpenaiEndpoint,
        'deploymentName': azureOpenaiDeploymentName.isEmpty
            ? 'Not configured'
