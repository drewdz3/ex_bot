                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Icon(goal.icon, color: isSelected ? Colors.white : Colors.grey[600], size: 18),
                              ),
...
class GoalOption {
  const GoalOption({required this.id, required this.title, required this.description, required this.icon});
