...
/// Adds pattern-matching-related methods to [ChatGptRequest].
extension ChatGptRequestPatterns on ChatGptRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChatGptRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChatGptRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChatGptRequest value)  $default,){
final _that = this;
switch (_that) {
case _ChatGptRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChatGptRequest value)?  $default,){
final _that = this;
switch (_that) {
case _ChatGptRequest() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String model,  List<ChatGptMessage> messages,  double temperature,  int maxTokens,  double topP,  double frequencyPenalty,  double presencePenalty,  List<String>? stop,  String? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatGptRequest() when $default != null:
return $default(_that.model,_that.messages,_that.temperature,_that.maxTokens,_that.topP,_that.frequencyPenalty,_that.presencePenalty,_that.stop,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String model,  List<ChatGptMessage> messages,  double temperature,  int maxTokens,  double topP,  double frequencyPenalty,  double presencePenalty,  List<String>? stop,  String? user)  $default,) {final _that = this;
switch (_that) {
case _ChatGptRequest():
return $default(_that.model,_that.messages,_that.temperature,_that.maxTokens,_that.topP,_that.frequencyPenalty,_that.presencePenalty,_that.stop,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String model,  List<ChatGptMessage> messages,  double temperature,  int maxTokens,  double topP,  double frequencyPenalty,  double presencePenalty,  List<String>? stop,  String? user)?  $default,) {final _that = this;
switch (_that) {
case _ChatGptRequest() when $default != null:
return $default(_that.model,_that.messages,_that.temperature,_that.maxTokens,_that.topP,_that.frequencyPenalty,_that.presencePenalty,_that.stop,_that.user);case _:
  return null;
