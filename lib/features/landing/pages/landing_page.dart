        ...
        state.when(
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  AppLocalizations.of(
                    context,
                  )!.welcomeBack(user.displayName ?? 'who are you?'),
                ),
                backgroundColor: Colors.green,
              ),
            );
            context.go(
              '/welcome/${user.displayName ?? AppConstants.emptyString}',
            );
          },
          unauthenticated: () {
            // Stay on login page
          ...
          error: (message) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  AppLocalizations.of(context)!.errorSignInFailed(message),
                ),
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    width: double.infinity,
                    child: TextButton(
                      onPressed: isLoading ? null : offline,
                      child: Text(AppLocalizations.of(context)!.btnGuest),
                    ),
                  ),
