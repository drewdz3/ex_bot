...
class _$AuthResultImpl implements _AuthResult {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, accessToken, account,
      const DeepCollectionEquality().hash(_scopes), expiresOn);
...
abstract class _AuthResult implements AuthResult {
  const factory _AuthResult(
      ...
      required final List<String> scopes,
      final DateTime? expiresOn}) = _$AuthResultImpl;
...
class _$UserProfileImpl implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(id: $id, email: $email, displayName: $displayName, givenName: $givenName, surname: $surname, preferredUsername: $preferredUsername, claims: $claims)';
  }
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      ...
      final String? surname,
      final String? preferredUsername,
      final Map<String, dynamic>? claims}) = _$UserProfileImpl;
